...
function EditCourse() {
    return (  
        <React.Fragment>
            ...
            <div className={ec.course-details}>
            <h1>EDIT COURSE</h1>
            ...
            <form method="post">
                ...
                <div className={ec.textfield}>
                <input className={ec.center-block} type="text" placeholder="Ex. CPSC 471" />
                </div>
                ...
                <div className={ec.textfield}>
                <input className={ec.center-block} type="text" placeholder="Description" />
                </div>

                <div className={ec.labels}>
                <label>Instructor's Name</label>
                </div>
                <div className={`${ec.textfield} ${ec.same-row}`}>
                ...
                <input className={ec.center-block} type="submit" value="Save" />
                </div>
            </form>
            </div>
        </React.Fragment>
